...
entity_relation_search <- function(client, cursor = NULL, limit = NULL, width = NULL, format = NULL, ..., .body = NULL, .protocol_version = TRE_PROTOCOL_VERSION) {
  auto_fields <- list(
    "cursor" = cursor,
    "limit" = limit,
    "width" = width,
...
entity_search <- function(client, cursor = NULL, limit = NULL, width = NULL, format = NULL, ..., .body = NULL, .protocol_version = TRE_PROTOCOL_VERSION) {
  auto_fields <- list(
    "cursor" = cursor,
    "limit" = limit,
    "width" = width,
