# Auto-generated command wrappers for Datastore, Semantic Catalog

datastore_adopt <- function(client, super_user = NULL, super_password_env = NULL, yes = NULL, format = NULL, ..., .body = NULL, .protocol_version = TRE_PROTOCOL_VERSION) {
  auto_fields <- list(
    "super-user" = super_user,
    "super-password-env" = super_password_env,
    "yes" = yes,
    "format" = format
  )
  tre_command_call(
...
datastore_create <- function(client, datastore = NULL, lake_base_path = NULL, super_user = NULL, super_password_env = NULL, force = NULL, yes = NULL, port = NULL, format = NULL, ..., .body = NULL, .protocol_version = TRE_PROTOCOL_VERSION) {
  auto_fields <- list(
    "datastore" = datastore,
...
datastore_list <- function(client, super_user = NULL, super_password_env = NULL, format = NULL, ..., .body = NULL, .protocol_version = TRE_PROTOCOL_VERSION) {
  auto_fields <- list(
    "super-user" = super_user,
    "super-password-env" = super_password_env,
    "format" = format
...
datastore_rotate <- function(client, super_user = NULL, super_password_env = NULL, yes = NULL, format = NULL, ..., .body = NULL, .protocol_version = TRE_PROTOCOL_VERSION) {
  auto_fields <- list(
    "super-user" = super_user,
    "super-password-env" = super_password_env,
    "yes" = yes,
...
datastore_schema <- function(client, super_user = NULL, super_password_env = NULL, port = NULL, format = NULL, ..., .body = NULL, .protocol_version = TRE_PROTOCOL_VERSION) {
  auto_fields <- list(
    "super-user" = super_user,
    "super-password-env" = super_password_env,
    "port" = port,
...
domain_get <- function(client, name = NULL, format = NULL, ..., .body = NULL, .protocol_version = TRE_PROTOCOL_VERSION) {
  auto_fields <- list(
    "name" = name,
    "format" = format
  )
...
tag_set <- function(client, target = NULL, name = NULL, tag = NULL, clear = NULL, domain = NULL, version = NULL, asset_type = NULL, format = NULL, ..., .body = NULL, .protocol_version = TRE_PROTOCOL_VERSION) {
  auto_fields <- list(
    "target" = target,
    "name" = name,
    "tag" = tag,
...
variable_list <- function(client, domain = NULL, format = NULL, ..., .body = NULL, .protocol_version = TRE_PROTOCOL_VERSION) {
  auto_fields <- list(
    "domain" = domain,
    "format" = format
  )
...
variable_search <- function(client, cursor = NULL, limit = NULL, width = NULL, format = NULL, ..., .body = NULL, .protocol_version = TRE_PROTOCOL_VERSION) {
  auto_fields <- list(
    "cursor" = cursor,
    "limit" = limit,
    "width" = width,
...
vocabulary_list <- function(client, domain = NULL, format = NULL, ..., .body = NULL, .protocol_version = TRE_PROTOCOL_VERSION) {
  auto_fields <- list(
    "domain" = domain,
    "format" = format
  )
